...
const App = () => {
  ...
  // --- プレビュー モーダル ---
  const [previewModal, setPreviewModal] = useState(null); // { title, embedUrl, type: 'youtube' | 'pdf' }
  ...
  const handleMaterialOpen = (e, m) => {
    ...
    if (embedUrl) {
      setPreviewModal({ title: m.title, embedUrl, type: 'youtube' });
      return;
    }
